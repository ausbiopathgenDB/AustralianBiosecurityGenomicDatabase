...
A triage system to stratify various biosecurity risk levels (low, medium and high) has been developed utilising the genome coverage metrics generated by read mapping to the Australian Biosecurity Genomic Database. The following are proposed thresholds for positive detection of a notifiable virus: 
...
-	This level of virus genome coverage indicates that positive detection of a notifiable virus is likely. 
...
![image](https://github.com/ausbiopathgenDB/Guides/assets/128443326/9f25a316-3bc9-456c-8c00-88b884217644)
...
All notifiable virus detections must be reported the relevant Australian reference laboratory or Chief Veterinary Officer, as they can organise further investigation of the sample with the appropriate testing laboratory. Multiple different data analyses should be provided to support the suspected detection of a notifiable virus detection and physical samples may be requested if available for confirmatory testing using diagnostic methods such as serology, culturing, or PCR. 
...
[Victoria]: <https://agriculture.vic.gov.au/biosecurity/animal-diseases/vetsource>
...
# State/territories disease list
All diseases on the state/territories disease list was reviewed and collated (Table 1). The list is comprised of 34 viruses, encompassing both aquatic and terrestrial diseases. Only viral diseases are listed with the national notifiable terrestrial and aquatic diseases removed from the list.  

<sub> **Table 1:** State/territories disease list. </sub>

<img width="562" alt="Screenshot 2023-08-08 005611" src="https://github.com/ausbiopathgenDB/Guides/assets/128443326/82fbe31d-16ba-4753-b7f2-b741922fcb4a">
